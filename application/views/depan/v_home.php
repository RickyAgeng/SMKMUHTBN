...
<head>
    ...
    <title>Selamat Datang di SMk Muhammadiyah Tuban</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/background-header3.jpg'?>" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/background-header4.jpg'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/background-header3.jpg'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Proses Belajar Interatif</h1>
                            <h4>Kami membuat proses belajar mengajar menjadi lebih interatif.<br> dengan demikian peserta didik lebih menyukai <br>proses belajar.</h4>
                            <div class="slider-btn">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="<?php echo base_url().'theme/images/foto-kepala-sekolah.jpeg'?>" class="img-fluid about-img" alt="#">
            </div>
        </div>
    </div>
</section>
...
<section class="mt-5">
    <div class="container">
        ...
        <div class="row program-card-container">
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="theme/images/logo.png" class="card-img-top" alt="Keahlian 1">
                        <div class="card-body">
                            <h5 class="card-title">Teknika Kapal Penangkap Ikan (TKPI)</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="theme/images/logo.png" class="card-img-top" alt="Keahlian 2">
                        <div class="card-body">
                            <h5 class="card-title">Nautika Kapal Penangkap Ikan (NKPI)</h5>
                            <a href="program_keahlian_nkpi.html" class="btn btn-primary">Detail</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="theme/images/logo.png" class="card-img-top" alt="Keahlian 3">
                        <div class="card-body">
                            <h5 class="card-title">Teknik Mesin <br>(TM)</h5>
                            <a href="#" class="btn btn-primary">Detail</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="theme/images/logo.png" class="card-img-top" alt="Keahlian 4">
                        <div class="card-body">
                            <h5 class="card-title">Agriteknologi Pengolahan Hasil Pertanian (APHP)</h5>
                            <a href="#" class="btn btn-primary">Detail</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-4">
                    <div class="course-img-wrap">
                        <img src="<?php echo base_url().'assets/images/'.$row->tulisanahli_gambar;?>" class="img-fluid" alt="courses-img">
                    </div>
                    <!-- // end .course-img-wrap -->
                    <a href="<?php echo site_url('keahlian/'.$row->tulisanahli_slug);?>" class="course-box-content">
                        <h3 style="text-align:center;"><?php echo $row->tulisanahli_judul;?></h3>
                    </a>
                </div>
            </div>
          <?php endforeach;?>
